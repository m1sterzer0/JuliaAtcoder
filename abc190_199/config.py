...
if __name__ == "__main__" :
    clargs = parseCLArgs()
    probList = []
    probList += [f"abc199_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc198_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc197_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc196_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc195_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc194_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc193_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc192_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc191_{x}" for x in ("A","B","C","D","E","F")]
    probList += [f"abc190_{x}" for x in ("A","B","C","D","E","F")]
